...
```{r}
#Exercise 1:
Plot_O3_Density <- ggplot(EPAair)+
  geom_density(aes(x = Ozone, fill = factor(Year)), alpha = 0.5)+
  scale_fill_brewer(palette = "Dark2")+
  labs (x = "Ozone AQI Value", 
        y = "Density", 
        fill = "")
print(Plot_O3_Density)

#Exercise 2: 
Plot_O3_Boxplot <- ggplot(EPAair, aes(x = factor(Year), y = Ozone))+
  geom_boxplot()+
  scale_fill_brewer(palette = "Dark2")+
  labs (x = "Year", 
        y = "Ozone AQI Value", 
        fill = "")+
  stat_summary(geom = "text", fun = max, label = c("Max2018", "Max2019"))
print(Plot_O3_Boxplot)

  
#Exercise 3: 
Plot_O3_Violin <- ggplot(EPAair, aes(x = factor(Year), y = Ozone))+
  geom_violin(draw_quantiles = 0.5)+
  labs (x = "Year", 
        y = "Ozone AQI Value", 
        fill = "")+
  stat_summary(geom = "text", fun = max, label = c("Max2018", "Max2019"))
print(Plot_O3_Violin)
```
