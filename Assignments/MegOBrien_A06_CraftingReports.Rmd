...
```{r, echo=FALSE, fig.cap='Mean Particulates (2.5mm)'}
...
```
\newpage
```{r, echo=FALSE, fig.cap='Mean Ozone'}
kable(summary_Ozone, 
      format = "markdown", 
      caption = "Mean Ozone",
      col.names = c("County", "$\\mu g/m^3$"), 
...
\newpage
```{r, echo=FALSE, warning=FALSE, fig.align='left', fig.height=2.5, fig.cap='Ozone Levels by Month (2018)'}

ozone_2018 <- subset(epa_data, Year == 2018)

Ozone_2018_plot <- ggplot(ozone_2018) +
geom_boxplot(aes(x = Month, y = Ozone, group = Month)) +
  labs(x = "Month", y = "Ozone (ppb)", title = "Ozone Levels by Month (2018)")

print(Ozone_2018_plot)

```

```{r, echo=FALSE, warning=FALSE, fig.align='left', fig.height=2.5, fig.cap='Ozone Levels by Month (2019)'}

ozone_2019 <- subset(epa_data, Year == 2019)

Ozone_2019_plot <- ggplot(ozone_2019) +
geom_boxplot(aes(x = Month, y = Ozone, group = Month)) +
  labs(x = "Month", y = "Ozone (ppb)", title = "Ozone Levels by Month (2019)")
...
https://github.com/ENV872/EDE_Fall2025.git

I did not use AI to generate code for this assignment. I did ask questions about some functions, but did not have any exact code written. 