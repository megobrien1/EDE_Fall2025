...
# multiplies all of the numbers in each vector, in order. 
vector1 * vector4

# multiplies all the values in the vector by 10. 
vector1 * 10

#converts lowercase to uppercase 
toupper(vector2) 

#inverts logical values
!vector3
...
temps_F <- c(81, 83, 83, 79, 77)

#What is the average of these temperatures 

average_value <- mean(temps_F)
print(average_value)

# The average temperature is 80.6
